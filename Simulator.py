...
class Simulator:
    def __init__(self, scheduler, lamb, avg_service_time, quantum, end_condition):
        # parameters for scheduler
        self.cpu = CPU()
        self.scheduler = scheduler
        self.lambda_val = lamb
    ...
    def generateReport(self):
        ...
        if self.scheduler == 1 and self.lambda_val == 1:
